...
function(OPENVDB_GET_VERSION_DEFINE HEADER KEY VALUE)
  ...
  if(details)
    ...
    string(REGEX REPLACE "^.*${KEY}[\t ]+([0-9]*).*$" "\\1" details
                         "${details}")
    set(${VALUE}
        ${details}
        PARENT_SCOPE)
...
function(OPENVDB_VERSION_FROM_HEADER OPENVDB_VERSION_FILE)
  ...
  openvdb_get_version_define(
    ${OPENVDB_VERSION_FILE} "OPENVDB_LIBRARY_MAJOR_VERSION_NUMBER"
    _OpenVDB_MAJOR_VERSION)
  openvdb_get_version_define(
    ${OPENVDB_VERSION_FILE} "OPENVDB_LIBRARY_MINOR_VERSION_NUMBER"
    _OpenVDB_MINOR_VERSION)
  openvdb_get_version_define(
    ${OPENVDB_VERSION_FILE} "OPENVDB_LIBRARY_PATCH_VERSION_NUMBER"
    _OpenVDB_PATCH_VERSION)
  openvdb_get_version_define(${OPENVDB_VERSION_FILE}
                             "OPENVDB_ABI_VERSION_NUMBER" _OpenVDB_ABI_VERSION)
...
function(OPENVDB_ABI_VERSION_FROM_PRINT OPENVDB_PRINT)
  ...
  set(_OpenVDB_ABI)
  string(REGEX REPLACE ".*abi([0-9]*).*" "\\1" _OpenVDB_ABI
                       ${_VDB_PRINT_VERSION_STRING})
